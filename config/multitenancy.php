...
return [
    /*
     * Custom host-first tenant finder with route fallback for the internal
     * organizer panel. Resolves by APP_URL root domain first (superadmin),
     * then by custom organizer domain, and falls back to the route parameter
     * for routes under the organizer namespace.
     */
    'tenant_finder' => App\Support\Multitenancy\OrganizerTenantFinder::class,
     ...
     */
    'tenant_model' => App\Models\Organizer::class,
